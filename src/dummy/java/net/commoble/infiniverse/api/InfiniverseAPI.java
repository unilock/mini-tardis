...
public interface InfiniverseAPI
{
	 ...
	 */
	public abstract ServerWorld getOrCreateLevel(final MinecraftServer server, final RegistryKey<World> levelKey, final Supplier<DimensionOptions> dimensionFactory);
	 ...
	 * <li>Unregistered dimensions will not be loaded on server startup unless and until they are registered again (via DimensionManager#getOrCreateLevel).
	 ...
	 */
	public abstract void markDimensionForUnregistration(final MinecraftServer server, final RegistryKey<World> levelToRemove);
	 ...
	 */
	public abstract Set<RegistryKey<World>> getLevelsPendingUnregistration();
}